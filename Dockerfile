...
MAINTAINER dns-admin@coozila.com
...
RUN groupadd -r --gid 2483 www-data \
 && useradd -r --uid 2483 -g www-data www-data

RUN chown www-data:www-data /var/www/html /var/www
